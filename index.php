  ...
  <main>
    ...
    <section id="banners" class="py-5 bg-light">
      <div class="container">
        ...
        <div class="row g-4 justify-content-center">
          ...
          <div class="col-6 col-md-4 col-lg-2">
            <div class="card text-center h-100 shadow-sm">
              <img src="./assets/img/cesto-oleo.png" class="card-img-top mx-auto mt-3" alt="Óleo" style="width: 60px;">
              <div class="card-body">
                <h6 class="fw-bold">Óleo</h6>
                <p class="card-text small">
                  Armazene adequadamente o óleo usado em garrafas bem vedadas. Um único litro pode contaminar até 25 mil
                  litros de água se descartado incorretamente.
                </p>
              </div>
            </div>
          </div>
    ...
    <section id="publico-alvo" class="py-5 bg-white">
      <div class="container">
        ...
        <div class="text-center mt-5">
          ...
          <a href="faleconosco.html" class="btn btn-success btn-lg shadow-sm">
            Fale Conosco
          </a>
        </div>
    ...
    <section class="section leaves d-flex justify-content-center align-items-center position-relative py-4 bg-light">
      ...
      <img src="./assets/img/folha.svg" alt="Folha esquerda"
        class="leaf floating-left position-absolute top-50 translate-middle-y d-none d-md-block" style="left: 40px;">
      ...
      <img src="./assets/img/planta.svg" alt="Folha direita"
        class="leaf floating-right position-absolute top-50 translate-middle-y d-none d-md-block"
        style="right: 40px; transform: translateY(-50%) scaleX(-1);">
