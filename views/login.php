            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-lg-4 mb-lg-0">
                        ...
                        <form action="../controllers/login_cidadao.php" method="POST">
                            <!-- Email -->
                            <div class="mb-3">
                            ...
                            <div class="d-grid mt-3">
                                <a href="../public/index.php" class="btn btn-success btn-lg">Entrar</a>
                            </div>
                            ...
                            <div class="d-flex justify-content-center mt-3">
                                <a href="esquecesenha.html" class="btn btn-link text-success me-3 p-1" style="font-size: 16px;">Esqueceu
                                    a senha?</a>
                                <a href="novocadastrocidadao.html" class="btn btn-link text-success p-1" style="font-size: 16px;">Novo
                                    Cadastro</a>
                            </div>
                        </form>
                    </div>
    ...
    <div class="container">
        <div class="row justify-content-center text-center">
            ...
            <div class="col-md-4 d-flex flex-column align-items-center">
                <h3 class="fw-bold mb-2 d-flex align-items-center justify-content-center">
                    <img src="../public/assets/img/icone.svg" alt="Ícone EcoCiclo" class="logo me-2">
                    EcoCiclo
                </h3>
                <p class="mb-0">Monitoramento inteligente para coleta eficiente</p>
            </div>
